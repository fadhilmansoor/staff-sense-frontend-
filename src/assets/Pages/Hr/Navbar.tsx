    ...
    <nav className=" bg-white w-full flex relative justify-between items-center mx-auto px-8 h-20">
        <div className="inline-flex">
            <a className="_o6689fn" href="/"
               ...
               <h1
              className="text-black text-left font-rochester text-3xl font-bold"
              style={{
                zIndex: 1, // Bring the text above the background image
                position: "absolute",
                top: 20,
                left: 20, // Adjust the left position to place it on the left side
              }}
            >
              StaffSense
            </h1>
                ...
                <div className="inline-flex items-center max-w-full">
                    <button className="flex items-center flex-grow-0 flex-shrink pl-2 relative w-60 border rounded-full px-1  py-1" type="button">
                        ...
                        <svg
                           ...
                           role="presentation"
                           focusable="false"
                           style={{ display: "block", fill: "none", height: "12px", width: "12px", stroke: "currentcolor", overflow: "visible" }}
                           strokeWidth={5.33333}
>
                                <g fill="none">
                                    <path
        ...
        <div className="flex-initial">
          <div className="flex justify-end items-center relative">
            ...
            <div className="flex mr-4 items-center">
              <a className="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" onClick={()=>manangerlist()}>
                <div className="flex items-center relative cursor-pointer whitespace-nowrap">MangerList</div>
              </a>
